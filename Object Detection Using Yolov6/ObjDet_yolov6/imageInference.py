...
from YOLOv6.yolov6.utils.torch_utils import get_model_info



class Inferer:
    def __init__(self, source, weights, device, yaml, img_size, half, conf_thres, iou_thres, classes, agnostic_nms, max_det):
        import glob
    ...
    @staticmethod
    def font_check(font='/Users/shubhamrathod/PycharmProjects/ObjDet_yolov6/YOLOv6/yolov6/utils/Arial.ttf', size=10):
